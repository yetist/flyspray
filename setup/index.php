  ...
  public function ProcessActions()
   ...
   public function ProcessAdminConfig($data)
   {
	...
	if(!isset($syntax_plugin)){$syntax_plugin="";}
      ...
      $config[] = 'cas_server_ca_cert_url = ""       ; Url to download the cas server certificate.';
      $config[] = 'cas_server_ca_cert_path = ""      ; Path to the ca chain that issued the cas server certificate.';
